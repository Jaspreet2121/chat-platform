...
| §9 test vs live | 2 (twin mint), 7 (isolation both directions), 8 (twin delivery log — pinned the gap-4 403 live on 2026-08-09; asserts reachable-with-evidence since the fix) | **walked 2026-08-09**; step 8's inverted assertion awaits the post-deploy run |
