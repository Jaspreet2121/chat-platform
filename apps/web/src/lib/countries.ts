// Static country data for the phone-login country-code selector. No runtime dependency: the flag is
// derived from the ISO-3166 alpha-2 code (regional-indicator code points), so we only store the name,
// iso2, and E.164 dial code. Pure data + pure helpers — no api/session/realtime logic.
...
// Alphabetical by name. Covers UN member states + commonly-used territories.
