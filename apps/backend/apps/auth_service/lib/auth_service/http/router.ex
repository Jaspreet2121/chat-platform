defmodule AuthService.HTTP.Router do
  ...
  post "/internal/app_auth/lookup_user" do
    send_result(conn, AuthService.AppAuth.lookup_external_user(body(conn)))
  end
  ...
  post "/internal/admin/users/summaries" do
    send_result(conn, {:ok, AuthService.Accounts.list_user_summaries(body(conn))})
  end
  ...
  post "/internal/devices/revoke_all" do
