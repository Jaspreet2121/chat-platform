defmodule MediaService.HealthGitShaTest do
  @moduledoc """
  ...
  test "carries git_sha beside service/status" do
    ...
    assert body["git_sha"] == "2cc6370",
           "media-service's health does not report its build — a mixed fleet mid-deploy is " <>
