defmodule MessageService.HealthGitShaTest do
  @moduledoc """
  ...
  test "carries git_sha beside service/status" do
    ...
    assert body["git_sha"] == "2cc6370",
           "message-service's health does not report its build — a mixed fleet mid-deploy is " <>
             "invisible from outside the box"

    assert body["service"] == "message"
