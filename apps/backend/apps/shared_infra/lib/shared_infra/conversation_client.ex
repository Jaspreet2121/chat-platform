defmodule SharedInfra.ConversationClient do
  ...
  @callback peers_of(attrs()) :: result()
  ...
  @callback set_sharing_disabled(attrs()) :: result()
  ...
  def peers_of(attrs), do: adapter().peers_of(attrs)
  ...
  def set_sharing_disabled(attrs), do: adapter().set_sharing_disabled(attrs)
